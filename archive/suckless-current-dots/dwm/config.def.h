...
//#include "themes/dwm-purple.h"
#include "themes/gruvbox-dark.h"
//#include "themes/white-black.h"
/* appearance */
...
//static const char *fonts[]          = {"Iosevka:style:medium:size=10" ,"JetBrainsMono Nerd Font Mono:style:medium:size=14" };
...
//static const char *fonts[]          = { "Iosevka:size=10", "JoyPixels:pixelsize=14:antialias=true:autohint=true"};
