...
static const ColorScheme schemes[] = {
 // st (dark)
 //{{"#222436", "red3", "green3", "yellow3",
 {{"#141827", "red3", "green3", "yellow3",
   "blue2", "magenta3", "cyan3", "gray90",
   "gray50", "red", "green", "yellow",
   "#afafff", "magenta", "cyan", "white",
...
static Shortcut shortcuts[] = {
	...
	{ MODS,               XK_1,           selectscheme,   {.i =  0} },
	{ MODS,               XK_2,           selectscheme,   {.i =  1} },
 	{ MODS,               XK_3,           selectscheme,   {.i =  2} },
 	{ MODS,               XK_4,           selectscheme,   {.i =  3} },
	{ MODS,               XK_5,           selectscheme,   {.i =  4} },
 	{ MODS,               XK_6,           selectscheme,   {.i =  5} },
 	{ MODS,               XK_7,           selectscheme,   {.i =  6} },
	{ MODS,               XK_8,           selectscheme,   {.i =  7} },
	{ MODS,               XK_9,           selectscheme,   {.i =  8} },
	{ MODS,               XK_0,           nextscheme,     {.i = +1} },
