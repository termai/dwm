...
//static const char *fonts[]          = {"Iosevka:style:medium:size=12" ,"JetBrainsMono Nerd Font Mono:style:medium:size=22" };
static const char *fonts[]          = {"Iosevka:style:medium:size=16" ,"JetBrainsMono Nerd Font Mono:style:medium:size=28" };
...
static const char *tagsel[][2] = {
   /*   fg         bg    */
  { normalfgcolor, "#141827" }, /* norm */
  { "#28fc03", "#141827"  }, /* sel */
  { "#ffffff",  "#141827" }, /* occ but not sel */
