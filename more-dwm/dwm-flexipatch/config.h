...
static const char *black[]    = {"nitrogen", "--set-zoom-fill", "/home/termi/wallpapers/wallhaven-57jml1.jpg",
NULL };
...
static const Key keys[] = {
	...
	#if SWITCHCOL_PATCH
	{ MODKEY|ControlMask,                       XK_v,          switchcol,              {0} },
	...
	{ MODKEY|ControlMask,                       XK_y,          togglefullscreen,       {0} },
